        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <div className="flex space-x-4" data-testid="footer-social-links">
              <a href="https://www.instagram.com/dreamyballoons14?igsh=MTJwb3N6bXI2bHR5Mw==" className="text-muted-foreground hover:text-primary transition-colors" data-testid="footer-instagram">
                <i className="fab fa-instagram text-xl"></i>
              </a>
              {/* <a href="#" className="text-muted-foreground hover:text-primary transition-colors" data-testid="footer-whatsapp">
                <i className="fab fa-whatsapp text-xl"></i>
              </a> */}
              <a href="https://www.facebook.com/share/1VjrtTQYP1/" className="text-muted-foreground hover:text-primary transition-colors" data-testid="footer-facebook">
          ...
          <div>
            ...
            <div className="space-y-2 text-muted-foreground">
              <a href="tel:+917669671650" data-testid="footer-phone"><i className="fas fa-phone mr-2" ></i>+91 7669671650</a>
              <br />
              <a href="mailto:vipinvipin35607@gmail.com" data-testid="footer-email"><i className="fas fa-envelope mr-2"></i>vipinvipin35607@gmail.com</a>
              <br />
              <p data-testid="footer-address"><i className="fas fa-map-marker-alt mr-2"></i>935, Mohan Meakin Society, Sector 5, Vasundhara, Ghaziabad, Uttar Pradesh 201012, India</p>
            </div>
          </div>
        </div>
        <div className="border-t border-border pt-8 mt-8 text-center text-muted-foreground" data-testid="footer-copyright">
          <p>&copy; 2025. All rights reserved. | Designed with <i className="fas fa-heart text-primary"></i> for your special moments.</p>
        </div>
      </div>
    </footer>
  );
